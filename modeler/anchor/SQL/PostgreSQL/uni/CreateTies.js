...
~*/
    ...
    if(tie.isHistorized()) {
/*~
-- Index for historized field $tie.changingColumnName on table $tie.capsule\.$tie.name --------------------------------
-----------------------------------------------------------------------------------------------------------------------

CREATE INDEX IF NOT EXISTS $tie.name\_$tie.changingColumnName\_idx ON $tie.capsule\.$tie.name ($tie.changingColumnName);	

--CLUSTER $tie.capsule\.$tie.name USING $tie.name\_$tie.changingColumnName\_idx;
